    ...
    <div className="flex bg-background min-h-screen">
      ...
      <aside className="h-screen w-64 fixed left-0 top-0 bg-surface flex flex-col py-md border-r border-outline-variant z-30">
        ...
        <nav className="flex-1 space-y-1">
          ...
          <a href="#" className="flex items-center px-md py-sm bg-primary text-white font-label-md text-label-md transition-colors duration-200">
      ...
      <main className="ml-64 mt-[64px] p-lg flex-1">
        ...
        <div className="mb-lg">
          <div className="flex justify-between items-end mb-md">
            ...
            <button 
              ...
              className="bg-primary text-white px-lg py-md rounded-lg flex items-center gap-sm font-label-md text-label-md hover:bg-primary-container transition-colors border border-primary active:scale-95"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-md">
            <div className="glass-panel p-md rounded-xl flex flex-col justify-between border-l-4 border-secondary hover:shadow-sm transition-all hover:border-secondary-fixed-dim">
            ...
            <div className="glass-panel p-md rounded-xl flex flex-col justify-between border-l-4 border-on-tertiary-container hover:shadow-sm transition-all hover:border-tertiary-fixed-dim">
              <div className="flex justify-between items-start">
            ...
            <div className="glass-panel p-md rounded-xl flex flex-col justify-between border-l-4 border-error hover:shadow-sm transition-all hover:border-error-container">
              <div className="flex justify-between items-start">
        ...
        {/* Filter Bar */}
        <div className="glass-panel p-sm rounded-lg mb-md flex flex-wrap items-center gap-md">
        ...
        {/* Data Table */}
        <div className="glass-panel rounded-xl overflow-hidden mb-lg">
          ...
          <div className="relative h-64 bg-surface-container-highest flex items-center justify-center">
            ...
            <div className="relative z-10 w-full h-full p-lg">
              <div className="absolute top-1/4 left-1/4 group cursor-pointer">
                ...
                <div className="hidden group-hover:block absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-primary text-white p-2 rounded text-[10px] whitespace-nowrap z-20 shadow-md">
            ...
            <div className="absolute bottom-md right-md bg-primary-container/90 backdrop-blur p-sm rounded border border-white/10 z-10">
              <div className="space-y-1">
                <div className="flex items-center gap-sm">
                  ...
                  <span className="font-label-sm text-label-sm text-white/80">Available / Active</span>
                </div>
                <div className="flex items-center gap-sm">
                  <span className="w-2 h-2 rounded-full bg-error"></span>
                  <span className="font-label-sm text-label-sm text-white/80">Maintenance Required</span>
                </div>
              </div>
            </div>
          </div>
