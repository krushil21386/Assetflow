                  ...
                  employees.map((emp) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-6 font-bold text-navy flex items-center gap-2">
                        <div className="h-7 w-7 rounded-full bg-gradient-to-tr from-brand-600 to-brand-400 text-navy flex items-center justify-center text-[10px] font-bold">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-xl bg-white border border-gray-300 focus:border-navy focus:ring-1 focus:ring-navy outline-none text-sm"
                  required
                />
              </div>
              ...
              {editingId && (
                <div className="space-y-1 p-3 rounded-xl bg-gray-50 border border-white/5 mt-4">
                  <label className="text-xs font-bold text-navy flex items-center gap-1.5 mb-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 rounded-xl bg-white border border-gray-300 focus:border-navy focus:ring-1 focus:ring-navy outline-none text-xs"
                  >
                    <option value="Employee" className="bg-surface-bg">
                      Employee (Default)
                    </option>
                    <option value="Department Head" className="bg-surface-bg">
                      Department Head
                    </option>
                    <option value="Asset Manager" className="bg-surface-bg">
                      Asset Manager
                    </option>
                    <option value="Admin" className="bg-surface-bg">
                      Admin
                    </option>
                  </select>
                </div>
              ...
              {!editingId && (
                <div className="space-y-3 p-3 rounded-xl bg-gray-50 border border-white/5 mt-2">
                  ...
                  {createAccount && (
                    <div className="space-y-1">
                      ...
                      <p className="text-[10px] text-brand-400 mt-1 italic">
                        Note: Default password for new accounts will be set to:
                        "Employee@123"
                      </p>
                    </div>
                  )}
