      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            Configure asset templates, depreciation timelines, and bookable
            states
          </p>
        </div>
        <button
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl bg-white border border-gray-300 focus:border-navy focus:ring-1 focus:ring-navy outline-none text-sm pr-12"
                      placeholder="36"
                      min="0"
                      required
                    />

                    <span className="absolute inset-y-0 right-0 pr-3 flex items-center text-xs text-gray-500">
                      months
                    </span>
                  </div>
                </div>
